local Library = {Toggle = false,FirstTab = nil,TabCount = 0,ColorTable = {}}
...
function Library:CreateWindow(Config, Parent)
	local WindowInit = {}
	local Folder = game:GetObjects("rbxassetid://10141794025")[1]
	...
	UserInputService.InputBegan:Connect(function(IO, Typing)
        ...
        if UserInputService:IsKeyDown(Config.Keybind) then
